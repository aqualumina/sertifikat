        ...
        <div class="card mb-4">
            ...
            <form action="/komik/edit/<?= $result['komik_id']?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="stok" name="stok" value="<?= old('stok', $result['stok']) ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <label for="komik_kategori_id" class="col-sm-2 col-form-label">Kategori</label>
                        <div class="col-sm-3">
                            <select type="text" class="form-control" id="komik_kategori_id" name="komik_kategori_id">
                                <?php foreach ($category as $value) : ?>
                                    <option value="<?= $value['komik_category_id'] ?>" <?= $value['komik_category_id']
                                                                                            == $result['komik_category_id'] ? 'selected' : '' ?>>
