            ...
            <th class="left" colspan="9">
                <form class="form-search" action="<?php echo site_url(); ?>c_acara/cari" method=POST>
                    ...
                    <div class="widget-toolbar">
                        <a href="<?php echo base_url(); ?>format/format_uploud_sertifikat.xlsx"><button class="btn btn-xs btn-success" type="button">Download Format Exel</button></a>

                        <a href="<?php echo base_url(); ?>c_acara/tbh" data-toggle="modal"><button class="btn btn-xs btn-primary" type="button">
