...
<div class="container p-0" id="sign-in-page-box">
                ...
                <div class="bg-white form-container sign-in-container">
                    <div class="sign-in-page-data">
                      <div class="sign-in-from w-100 m-auto">
                          <h1 class="mb-3 text-center">Pendaftaran Akun</h1>
                          <p class="text-center text-dark ">Enter your email address and password to access admin panel.</p>
                        ...
                        <div class="small">Sudah Punya Akun ? <a href="/login">Login Disini</a></div>
                    </div>
                            </div>
                          </form>
                      </div>
                ...
                <div class="overlay-container">
                    <div class="overlay">
                        <div class="overlay-panel overlay-left">
                            ...
                            <button class="btn iq-border-primary" id="signIn">Sign Up</button>
                        </div>
                        <div class="overlay-panel overlay-right">
                            <a class="sign-in-logo mb-5" href="#"><img src="images/logo-full.png" class="img-fluid" alt="logo"></a>
                            <p>Enter your personal details and start journey with us</p>
                            <button class="btn iq-border-primary" id="signUp">Sign In</button>
                        </div>
                    </div>
                </div>
            </div>
