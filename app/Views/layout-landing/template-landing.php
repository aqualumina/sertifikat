...
<body>
   ...
   <div class="wrapper">
      ...
      <div class="iq-top-navbar">
         <?= $this->include('layout-landing/header-landing') ?>
      </div>
      <!-- TOP Nav Bar END -->
      <!-- Page Content  -->
   ...
   <script>
      function previewTTD() {
         ...
         const fileTTD = new FileReader();
         fileTTD.readAsDataURL(ttd.files[0]);
         fileTTD.onload = function(e) {
      ...
      function previewCap() {
         ...
         const imgPreview = document.querySelector('.img-preview-cap');
         const fileCap = new FileReader();
         fileCap.readAsDataURL(cap.files[0]);
         fileCap.onload = function(e) {
            imgPreview.src = e.target.result;
         }
